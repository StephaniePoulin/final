...
function validate() {
  var formName = document.forms['feedback']['name'].value;
  console.log(formName);
  var formLastname = document.forms['feedback']['lastname'].value;
  console.log(formLastname);
  var formWebsite = document.forms['feedback']['website'].value;
  console.log(formWebsite);
  var formYesno = document.forms['feedback']['yesno'].value;
